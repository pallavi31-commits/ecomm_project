    ...
    try{
        ...
        if(!req.body.name){
            return res.status(400).send({
                message : "Failed ! Name was not provied in requst body"
            })
        }
        ...
        if(!req.body.email){
            return res.status(400).send({
                message : "Failed ! email was not provied in requst body"
            })
        }
        ...
        if(!req.body.userId){
            return res.status(400).send({
                message : "Failed ! userId was not provied in requst body"
            })
        }
